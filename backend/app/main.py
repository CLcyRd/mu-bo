...
from .routers import bookings, auth, auth_wechat, users, consultations, volunteers, audio_explanations, product, museum_info
...
app.include_router(museum_info.router)
